...
**Options** I've provided a couple of options for some of the connectors. You can either run wires to the holes or you can buy the parts. When you see an option (A) and (B) for a particular PART, then you'll have to choose which option (A or B) you prefer. You'll buy all listed under PART(A) or under PART(B). Don't buy both. 
...
**Holes** There are four mounting holes to connect to the metal cas which are electrically connected to the board's ground plane. 

**Case** I ordered an aluminum case so I'll have to drill out the holes, but I'm curious to see how the 9V really fits. 
